...
class _RegisterViewState extends State<RegisterView> {
  ...
  final _fnameController = TextEditingController(text: 'saroj');
  final _lnameController = TextEditingController(text: 'shah');
  final _phoneController = TextEditingController(text: '123456789');
  final _usernameController = TextEditingController(text: 'saroj');
  final _passwordController = TextEditingController(text: 'saroj123');
