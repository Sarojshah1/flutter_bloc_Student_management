...
Future<void> _initAuthModule() async {
  ...
  serviceLocator.registerFactory(()=>StudentRemoteDatasource(apiservice: serviceLocator<ApiService>()));
  ...
  serviceLocator.registerFactory(()=>StudentRemoteRepository(datasource: serviceLocator<StudentRemoteDatasource>()));
